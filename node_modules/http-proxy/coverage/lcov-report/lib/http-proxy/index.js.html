...
<a name='L186'></a><a href='#L186'>186</a></td><td class="line-coverage quiet"><span
...
&nbsp;
<span class="cstat-no" title="statement not covered">  return <span class="fstat-no"
                                                                    title="function not covered">fu</span>nction(options) {</span>
<span class="cstat-no" title="statement not covered">    return <span class="fstat-no"
                                                                      title="function not covered">fu</span>nction(req, res /*, [head], [opts] */) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">      ['target', 'forward'].forEach(<span class="fstat-no"
                                                                                               title="function not covered">fu</span>nction(e) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">  this.webPasses = Object.keys(web).map(<span class="fstat-no"
                                                                                                   title="function not covered">fu</span>nction(pass) {</span>
<span class="cstat-no" title="statement not covered">    return web[pass];</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered">  this.wsPasses = Object.keys(ws).map(<span class="fstat-no"
                                                                                                 title="function not covered">fu</span>nction(pass) {</span>
...
ProxyServer.prototype.listen = <span class="fstat-no" title="function not covered">fu</span>nction(port, hostname) {
  var self    = <span class="cstat-no" title="statement not covered">this,</span>
      closure = <span class="cstat-no" title="statement not covered"><span class="fstat-no"
                                                                           title="function not covered">fu</span>nction(req, res) { <span
            class="cstat-no" title="statement not covered">self.web(req, res); </span>};</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered">    this._server.on('upgrade', <span class="fstat-no"
                                                                                          title="function not covered">fu</span>nction(req, socket, head) { <span
        class="cstat-no" title="statement not covered">self.ws(req, socket, head); </span>});</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered">    throw new Error('type must be `web` or `ws`');</span>
  ...
  var passes = <span class="cstat-no"
                     title="statement not covered">(type === 'ws') ? this.wsPasses : this.webPasses,</span>
      i = <span class="cstat-no" title="statement not covered">false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered">  passes.forEach(<span class="fstat-no"
                                                                            title="function not covered">fu</span>nction(v, idx) {</span>
<span class="cstat-no" title="statement not covered">    if(v.name === passName) <span class="cstat-no"
                                                                                       title="statement not covered">i = idx;</span></span>
  })
&nbsp;
<span class="cstat-no" title="statement not covered">  if(i === false) <span class="cstat-no"
                                                                             title="statement not covered">throw new Error('No such pass');</span></span>
&nbsp;
