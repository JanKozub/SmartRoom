...
<a name='L193'></a><a href='#L193'>193</a></td><td class="line-coverage quiet"><span
        class="cline-any cline-yes">1x</span>
...
<span class="cstat-no" title="statement not covered">    if(!options.xfwd) <span class="cstat-no"
                                                                                 title="statement not covered">return;</span></span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered">    ['for', 'port', 'proto'].forEach(<span class="fstat-no"
                                                                                                title="function not covered">fu</span>nction(header) {</span>
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">    req.headers['x-forwarded-host'] = req.headers['host'] || '';</span>
  },
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered">      if(!options.target) { <span class="cstat-no"
                                                                                       title="statement not covered">return res.end(); </span>}</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered">    proxyReq.on('socket', <span class="fstat-no"
                                                                                     title="function not covered">fu</span>nction(socket) {</span>
<span class="cstat-no" title="statement not covered">      if(server) { <span class="cstat-no"
                                                                              title="statement not covered">server.emit('proxyReq', proxyReq, req, res, options); </span>}</span>
    });
&nbsp;
    // allow outgoing socket to timeout so that we could
    // show an error page at the initial request
<span class="cstat-no" title="statement not covered">    if(options.proxyTimeout) {</span>
<span class="cstat-no" title="statement not covered">      proxyReq.setTimeout(options.proxyTimeout, <span
        class="fstat-no" title="function not covered">fu</span>nction() {</span>
<span class="cstat-no" title="statement not covered">         proxyReq.abort();</span>
      });
    }
&nbsp;
    // Ensure we abort proxy if request is aborted
<span class="cstat-no" title="statement not covered">    req.on('aborted', <span class="fstat-no"
                                                                                 title="function not covered">fu</span>nction () {</span>
<span class="cstat-no" title="statement not covered">      proxyReq.abort();</span>
    });
&nbsp;
    // handle errors in proxy and incoming request, just like for forward proxy
    var proxyError = <span class="cstat-no"
                           title="statement not covered">createErrorHandler(proxyReq, options.target);</span>
...
<span class="cstat-no" title="statement not covered">      return function <span class="fstat-no"
                                                                                 title="function not covered">proxyError(</span>err) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">    proxyReq.on('response', <span class="fstat-no"
                                                                                       title="function not covered">fu</span>nction(proxyRes) {</span>
<span class="cstat-no" title="statement not covered">      if(server) { <span class="cstat-no"
                                                                              title="statement not covered">server.emit('proxyRes', proxyRes, req, res); </span>}</span>
&nbsp;
<span class="cstat-no"
      title="statement not covered">      if(!res.headersSent &amp;&amp; !options.selfHandleResponse) {</span>
<span class="cstat-no" title="statement not covered">        for(var i=0; i &lt; web_o.length; i++) {</span>
<span class="cstat-no" title="statement not covered">          if(web_o[i](req, res, proxyRes, options)) { <span
        class="cstat-no" title="statement not covered">break; </span>}</span>
        }
      }
&nbsp;
<span class="cstat-no" title="statement not covered">      if (!res.finished) {</span>
        // Allow us to listen when the proxy has completed
<span class="cstat-no" title="statement not covered">        proxyRes.on('end', <span class="fstat-no"
                                                                                      title="function not covered">fu</span>nction () {</span>
<span class="cstat-no" title="statement not covered">          if (server) <span class="cstat-no"
                                                                                 title="statement not covered">server.emit('end', req, res, proxyRes);</span></span>
        });
        // We pipe to the response unless its expected to be handled by the user
<span class="cstat-no" title="statement not covered">        if (!options.selfHandleResponse) <span class="cstat-no"
                                                                                                    title="statement not covered">proxyRes.pipe(res);</span></span>
      } else {
<span class="cstat-no" title="statement not covered">        if (server) <span class="cstat-no"
                                                                               title="statement not covered">server.emit('end', req, res, proxyRes);</span></span>
      }
...
<div class='footer quiet pad2 space-top1 center small'>
    Code coverage
    generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Apr 19 2018 20:20:29 GMT-0400
    (EDT)
</div>
</div>
