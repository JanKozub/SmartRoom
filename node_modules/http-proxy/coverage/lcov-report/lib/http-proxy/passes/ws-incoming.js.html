...
<a name='L163'></a><a href='#L163'>163</a></td><td class="line-coverage quiet"><span
...
&nbsp;
    var createHttpHeader = <span class="cstat-no" title="statement not covered"><span class="fstat-no"
                                                                                      title="function not covered">fu</span>nction(line, headers) {</span>
<span class="cstat-no" title="statement not covered">      return Object.keys(headers).reduce(<span class="fstat-no"
                                                                                                    title="function not covered">fu</span>nction (head, key) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">    if (head &amp;&amp; head.length) <span class="cstat-no"
                                                                                                title="statement not covered">socket.unshift(head);</span></span>
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered">    if (server) { <span class="cstat-no"
                                                                             title="statement not covered">server.emit('proxyReqWs', proxyReq, req, socket, options, head); </span>}</span>
&nbsp;
    // Error Handler
...
<span class="cstat-no" title="statement not covered">    proxyReq.on('response', <span class="fstat-no"
                                                                                       title="function not covered">fu</span>nction (res) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">    proxyReq.on('upgrade', <span class="fstat-no"
                                                                                      title="function not covered">fu</span>nction(proxyRes, proxySocket, proxyHead) {</span>
<span class="cstat-no" title="statement not covered">      proxySocket.on('error', onOutgoingError);</span>
&nbsp;
      // Allow us to listen when the websocket has completed
<span class="cstat-no" title="statement not covered">      proxySocket.on('end', <span class="fstat-no"
                                                                                       title="function not covered">fu</span>nction () {</span>
<span class="cstat-no"
      title="statement not covered">        server.emit('close', proxyRes, proxySocket, proxyHead);</span>
      });
&nbsp;
      // The pipe below will end proxySocket if socket closes cleanly, but not
      // if it errors (eg, vanishes from the net and starts returning
      // EHOSTUNREACH). We need to do that explicitly.
<span class="cstat-no" title="statement not covered">      socket.on('error', <span class="fstat-no"
                                                                                    title="function not covered">fu</span>nction () {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">      if (proxyHead &amp;&amp; proxyHead.length) <span
        class="cstat-no" title="statement not covered">proxySocket.unshift(proxyHead);</span></span>
&nbsp;
      //
