...
<a name='L148'></a><a href='#L148'>148</a></td><td class="line-coverage quiet"><span
...
&nbsp;
  setRedirectHostRewrite: function setRedirectHostRewrite(req, res, proxyRes, options) {
    <span class="missing-if-branch" title="else path not taken">E</span>if ((options.hostRewrite || options.autoRewrite || <span
            class="branch-2 cbranch-no" title="branch not covered">options.protocolRewrite)</span>
...
<span class="cstat-no" title="statement not covered">      proxyRes.headers['location'] = u.format();</span>
  ...
  writeHeaders: function <span class="fstat-no" title="function not covered">writeHeaders(</span>req, res, proxyRes, options) {
    var rewriteCookieDomainConfig = <span class="cstat-no"
                                          title="statement not covered">options.cookieDomainRewrite,</span>
        rewriteCookiePathConfig = <span class="cstat-no" title="statement not covered">options.cookiePathRewrite,</span>
        preserveHeaderKeyCase = <span class="cstat-no"
                                      title="statement not covered">options.preserveHeaderKeyCase,</span>
        rawHeaderKeyMap,
        setHeader = <span class="cstat-no" title="statement not covered"><span class="fstat-no"
                                                                               title="function not covered">fu</span>nction(key, header) {</span>
<span class="cstat-no" title="statement not covered">          if (header == undefined) <span class="cstat-no"
...
<span class="cstat-no"
      title="statement not covered">      rewriteCookiePathConfig = { '*': rewriteCookiePathConfig };</span>
    }
&nbsp;
...
<span class="cstat-no"
      title="statement not covered">      for (var i = 0; i &lt; proxyRes.rawHeaders.length; i += 2) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">    Object.keys(proxyRes.headers).forEach(<span class="fstat-no"
                                                                                                     title="function not covered">fu</span>nction(key) {</span>
      var header = <span class="cstat-no" title="statement not covered">proxyRes.headers[key];</span>
<span class="cstat-no"
      title="statement not covered">      if (preserveHeaderKeyCase &amp;&amp; rawHeaderKeyMap) {</span>
