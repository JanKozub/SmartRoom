...
<a name='L249'></a><a href='#L249'>249</a></td><td class="line-coverage quiet"><span
...
<span class="fstat-no" title="function not covered">    fu</span>nction(e) { <span class="cstat-no"
                                                                                   title="statement not covered">outgoing[e] = options[forward || 'target'][e]; </span>}
  );
&nbsp;
...
&nbsp;
  ...
  var targetPath = <span class="cstat-no"
                         title="statement not covered">target &amp;&amp; options.prependPath !== false</span>
    ? (target.path || '')
    : '';
&nbsp;
  //
...
<span class="cstat-no"
      title="statement not covered">  return Boolean(req.connection.encrypted || req.connection.pair);</span>
};
&nbsp;
/**
 ...
 * @api private
 */
common.rewriteCookieProperty = function <span class="fstat-no"
                                              title="function not covered">rewriteCookieProperty(</span>header, config, property) {
<span class="cstat-no" title="statement not covered">  if (Array.isArray(header)) {</span>
<span class="cstat-no" title="statement not covered">    return header.map(<span class="fstat-no"
                                                                                 title="function not covered">fu</span>nction (headerElement) {</span>
<span class="cstat-no" title="statement not covered">      return rewriteCookieProperty(headerElement, config, property);</span>
    });
  }
<span class="cstat-no" title="statement not covered">  return header.replace(new RegExp("(;\\s*" + property + "=)([^;]+)", 'i'), <span
        class="fstat-no" title="function not covered">fu</span>nction(match, prefix, previousValue) {</span>
    var newValue;
