...
<body class="centered" unresolved>
...
<demo-snippet>
    <template>
        ...
        <simple-overlay id="backdrop" scroll-action="lock" with-backdrop>
            <p>Hello world!</p>
...
<h3>Use <code>restore-focus-on-close</code> to return the focus to the element that opened the overlay when it gets
    closed.</h3>
<demo-snippet>
    <template>
...
<demo-snippet>
    <template>
        ...
        <simple-overlay always-on-top id="onTop" tabindex="-1">
            <h2>Always on top</h2>
            <button onclick="backdrop2.open()">Open with backdrop</button>
            <button onclick="onTop.close()">Close this</button>
        </simple-overlay>
        <simple-overlay id="backdrop2" tabindex="-1" with-backdrop>
            <h2>With backdrop</h2>
...
<demo-snippet>
    <template>
        ...
        <simple-overlay class="with-margin scrollable" id="scrolling" scroll-action="lock" tabindex="-1">
        ...
        <simple-overlay class="with-margin" id="scrolling2" scroll-action="lock" tabindex="-1">
...
<demo-snippet>
    <template>
        ...
        <simple-overlay allow-click-through horizontal-align="left" id="toast" no-auto-focus no-cancel-on-outside-click
...
<demo-snippet>
    <template>
      <span>
        ...
        <simple-overlay horizontal-align="left" id="lockOnScroll" no-overlap scroll-action="lock" tabindex="-1"
                        vertical-align="bottom">
        ...
        <simple-overlay horizontal-align="left" id="refitOnScroll" no-overlap scroll-action="refit" tabindex="-1"
                        vertical-align="bottom">
        ...
        <simple-overlay horizontal-align="left" id="cancelOnScroll" no-overlap scroll-action="cancel" tabindex="-1"
                        vertical-align="bottom">
