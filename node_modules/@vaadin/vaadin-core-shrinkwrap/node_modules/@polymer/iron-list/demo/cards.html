...
<dom-module id="x-list">
    <template>
        ...
        <app-header condenses effects="resize-title blend-background waterfall" fixed>
            <app-toolbar>
        ...
        <iron-list as="item" items="[[data]]" scroll-target="document">
            <template>
                <div>
                    <div class="item" tabindex$="[[tabIndex]]">
                        ...
                        <div class="pad">
                            ...
                            <div><a href="#">Link 1</a> <a href="#">Link 2</a> <a href="#">Link 3</a> <a href="#">Link
                                4</a></div>
