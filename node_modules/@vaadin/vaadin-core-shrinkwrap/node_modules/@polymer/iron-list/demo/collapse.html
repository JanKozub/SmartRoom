...
<dom-module id="x-collapse">
    <template>
      ...
      @media (max-width: 460px) {
        ...
        <iron-ajax auto last-response="{{items}}" url="data/contacts.json"></iron-ajax>

        <app-toolbar>
            <div main-title>Collapsible items</div>
            <paper-icon-button alt="Search" icon="search"></paper-icon-button>
            <paper-icon-button alt="More options" icon="more-vert"></paper-icon-button>
        </app-toolbar>

        <iron-list as="item" id="list" items="[[items]]" multi-selection selection-enabled>
            <template>
                <div>
