...
<custom-style>
    <style include="demo-pages-shared-styles" is="custom-style">
      .centered {
        min-width: 600px;
      }
    ...
    <template>
        ...
        <dom-bind>
            <template is="dom-bind">
                ...
                <simple-fit auto-fit-on-attach id="myFit">
                    <h2>Align</h2>
                    <p>
                    ...
                    <p>
                        <button horizontal-align="left" on-tap="updateAlign">left</button>
                        <button horizontal-align="center" on-tap="updateAlign">center</button>
                        <button horizontal-align="right" on-tap="updateAlign">right</button>
                        <button horizontal-align="auto" on-tap="updateAlign">auto</button>
                        <button horizontal-align on-tap="updateAlign">null</button>
                    </p>
