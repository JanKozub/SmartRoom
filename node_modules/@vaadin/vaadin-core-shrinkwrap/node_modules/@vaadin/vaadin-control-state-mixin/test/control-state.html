...
<head>
    ...
    <script src="../vaadin-control-state-mixin.js" type="module"></script>
</head>
...
class TestWrapper extends ControlStateMixin(PolymerElement) {
  static get is() {
    return 'test-wrapper';
  }
...
import { ControlStateMixin } from '../vaadin-control-state-mixin.js';
import { PolymerElement } from '@polymer/polymer/polymer-element.js';
class TestElement extends ControlStateMixin(PolymerElement) {
  static get is() {
    return 'test-element';
  }
