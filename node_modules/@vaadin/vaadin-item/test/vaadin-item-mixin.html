...
<head>
    ...
    <script src="../../../@polymer/polymer/polymer-element.js" type="module"></script>
    <script src="../../../@polymer/iron-test-helpers/iron-test-helpers.js" type="module"></script>
    <script src="../../../@polymer/test-fixture/test-fixture.js" type="module"></script>
    <script src="../vaadin-item-mixin.js" type="module"></script>
</head>
...
import '../vaadin-item-mixin.js';
import { ItemMixin } from '../src/vaadin-item-mixin.js';
class TestElement extends ItemMixin(PolymerElement) {
  static get is() {
    return 'test-element';
  }
}
...
describe('vaadin-item-mixin', () => {
  ...
  describe('with clickable child', () => {
    beforeEach(() => item = fixture('withButton'));
