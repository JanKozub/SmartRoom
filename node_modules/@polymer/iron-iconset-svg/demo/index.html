...
<div class="vertical-section-container centered">
    ...
    <demo-snippet>
        <template>
            ...
            <iron-icon aria-label="CodePen logo" icon="svg-sample-icons:codepen" role="img"></iron-icon>
            <iron-icon aria-label="Twitter logo" icon="svg-sample-icons:twitter" role="img"></iron-icon>
            <iron-icon aria-label="YouTube logo" icon="svg-sample-icons:youtube" role="img"></iron-icon>
        </template>
    </demo-snippet>
        ...
        <template>
            <iron-iconset-svg name="inline" size="24">
                <svg>
                    <defs>
                        <g id="shape">
                            <rect height="24" width="12" x="12" y="0"></rect>
            ...
            <iron-icon aria-label="A shape" icon="inline:shape" role="img"></iron-icon>
        </template>
    </demo-snippet>
</div>
</body>
